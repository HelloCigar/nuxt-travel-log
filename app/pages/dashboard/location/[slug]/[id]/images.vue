...
<template>
  <div>
    ...
    <div class="flex flex-col gap-2 w-72">
      <div class="bg-gray-500 h-30 w-full flex justify-center items-center p-0.5 relative">
      ...
      <input type="file" class="file-input" @change="selectImage" :disabled="loading">
      <button
       @click="uploadImage"
       class="btn btn-accent" :disabled="!image || loading">
        Upload
      </button>
    </input>
    </div>
